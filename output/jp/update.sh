...
if get_ip_down "fe80::1817:5" "dn42-hk-4"; then
    update_wg_peer dn42-hk-4 "PBeqRWWbRkK2J7eZM+Fks5CX7V60ModeFO+sNEz2aWQ=" "$ip_hk_4:18002" "igp_tunnels/dn42-hk-4.conf"
fi
if get_ip_down "fe80::1817:5" "dn42-hk-6"; then
    update_wg_peer dn42-hk-6 "PBeqRWWbRkK2J7eZM+Fks5CX7V60ModeFO+sNEz2aWQ=" "$ip_hk_6:18003" "igp_tunnels/dn42-hk-6.conf"
fi
if get_ip_down "fe80::1817:8" "dn42-usfmt-4"; then
    update_wg_peer dn42-usfmt-4 "/ITn6sdA5luUrPoWFfWtLNbJic5WKL9smFomCLXuQDE=" "$ip_usfmt_4:18002" "igp_tunnels/dn42-usfmt-4.conf"
fi
if get_ip_down "fe80::1817:8" "dn42-usfmt-6"; then
    update_wg_peer dn42-usfmt-6 "/ITn6sdA5luUrPoWFfWtLNbJic5WKL9smFomCLXuQDE=" "$ip_usfmt_6:18003" "igp_tunnels/dn42-usfmt-6.conf"
fi
if get_ip_down "fe80::1817:a" "dn42-de-6"; then
    update_wg_peer dn42-de-6 "bEGjgZ0gabtfilwb4Z+2IV4ytlTgEu0VhAtvl1V+mSk=" "$ip_de_6:18001" "igp_tunnels/dn42-de-6.conf"
fi
if get_ip_down "fe80::1817:c" "dn42-cnjs-4"; then
    update_wg_peer dn42-cnjs-4 "OPfWD88pEx4nWIn/YB836bmw/I7a+P4TyuAgGmOGPys=" "$ip_cnjs_4:42071" "igp_tunnels/dn42-cnjs-4.conf"
fi
if get_ip_down "fe80::1817:10" "dn42-cnzj-4"; then
    update_wg_peer dn42-cnzj-4 "+g0GBYWJLj4/48IdRNsNtgWrQGqwr5q0bJHySW3qBjs=" "$ip_cnzj_4:14871" "igp_tunnels/dn42-cnzj-4.conf"
fi
if get_ip_down "fe80::1817:10" "dn42-cnzj-6"; then
    update_wg_peer dn42-cnzj-6 "+g0GBYWJLj4/48IdRNsNtgWrQGqwr5q0bJHySW3qBjs=" "$ip_cnzj_6:14872" "igp_tunnels/dn42-cnzj-6.conf"
fi
if get_ip_down "fe80::1817:12" "dn42-cngd-6"; then
    update_wg_peer dn42-cngd-6 "DoLZhYaX05QJgPfQxd+Kp8SCj21uR7pSZi/JBmyNP1o=" "$ip_cngd_6:18001" "igp_tunnels/dn42-cngd-6.conf"
fi
if get_ip_down "fe80::1817:13" "dn42-cncs-4"; then
    update_wg_peer dn42-cncs-4 "j5xSk2xuVKgAADdT+3R4L//CWAMfgM3Wy9vcIF2TQQM=" "$ip_cncs_4:31981" "igp_tunnels/dn42-cncs-4.conf"
fi
if get_ip_down "fe80::1817:14" "dn42-usfmt2-4"; then
    update_wg_peer dn42-usfmt2-4 "AQJPoutD8D0YMUS2BOrhE0Drlzce4LQOO2ZK1UY8JRg=" "$ip_usfmt2_4:18001" "igp_tunnels/dn42-usfmt2-4.conf"
fi
if get_ip_down "fe80::1817:15" "dn42-de2-4"; then
    update_wg_peer dn42-de2-4 "aHAbIRzMq9y9w48hMOhS4/HwhVD6zU6Jn3ESFbFxDHE=" "$ip_de2_4:13483" "igp_tunnels/dn42-de2-4.conf"
fi
if get_ip_down "fe80::1817:15" "dn42-de2-6"; then
    update_wg_peer dn42-de2-6 "aHAbIRzMq9y9w48hMOhS4/HwhVD6zU6Jn3ESFbFxDHE=" "$ip_de2_6:13484" "igp_tunnels/dn42-de2-6.conf"
fi


wg set dn42-cnzj-4 peer "+g0GBYWJLj4/48IdRNsNtgWrQGqwr5q0bJHySW3qBjs=" endpoint "$ip_cnzj_4:14871"
wg set dn42-cnzj-6 peer "+g0GBYWJLj4/48IdRNsNtgWrQGqwr5q0bJHySW3qBjs=" endpoint "$ip_cnzj_6:14872"

...
if get_ip_down "fe80::1817:8" "dn42-usfmt-4"; then
    update_wg_peer dn42-usfmt-4 "7hb3TPpacgb9xsCtuPcQdP4r1zQx+N9mceaSJ0jF/hY=" "$ip_usfmt_4:18004" "igp_tunnels/dn42-usfmt-4.conf"
fi
if get_ip_down "fe80::1817:8" "dn42-usfmt-6"; then
    update_wg_peer dn42-usfmt-6 "7hb3TPpacgb9xsCtuPcQdP4r1zQx+N9mceaSJ0jF/hY=" "$ip_usfmt_6:18005" "igp_tunnels/dn42-usfmt-6.conf"
fi
if get_ip_down "fe80::1817:a" "dn42-de-6"; then
    update_wg_peer dn42-de-6 "QVCvhxPMyCLPsMyR4eoJfGBO0SES4QS7u5KN+H4K3y4=" "$ip_de_6:18002" "igp_tunnels/dn42-de-6.conf"
fi
if get_ip_down "fe80::1817:c" "dn42-cnjs-4"; then
    update_wg_peer dn42-cnjs-4 "ufa7Qg2MfpU1LW+EuykuAML7x6bhEFmIbmE0hNJnl1o=" "$ip_cnjs_4:42072" "igp_tunnels/dn42-cnjs-4.conf"
fi
if get_ip_down "fe80::1817:10" "dn42-cnzj-4"; then
    update_wg_peer dn42-cnzj-4 "e/lg8d/pOJA3sEBqrdTNZ6dMd5ZRCXR0oNfXQW5KIjw=" "$ip_cnzj_4:14873" "igp_tunnels/dn42-cnzj-4.conf"
fi
if get_ip_down "fe80::1817:10" "dn42-cnzj-6"; then
    update_wg_peer dn42-cnzj-6 "e/lg8d/pOJA3sEBqrdTNZ6dMd5ZRCXR0oNfXQW5KIjw=" "$ip_cnzj_6:14874" "igp_tunnels/dn42-cnzj-6.conf"
fi
if get_ip_down "fe80::1817:12" "dn42-cngd-6"; then
    update_wg_peer dn42-cngd-6 "7WZMs3Qh6gon+PX6Iz5IzBTIeE+TQMwWVu/PAG1OH0I=" "$ip_cngd_6:18002" "igp_tunnels/dn42-cngd-6.conf"
fi
if get_ip_down "fe80::1817:13" "dn42-cncs-4"; then
    update_wg_peer dn42-cncs-4 "NueWyuYQYZo8lB6X8Jd/mShJeNH4UlboiAJ8kZdZFXM=" "$ip_cncs_4:31982" "igp_tunnels/dn42-cncs-4.conf"
fi
if get_ip_down "fe80::1817:14" "dn42-usfmt2-4"; then
    update_wg_peer dn42-usfmt2-4 "lkJVxOPx1EIt2YINSpTD+jFcN36pnCvHWXD6QG3DqjM=" "$ip_usfmt2_4:18002" "igp_tunnels/dn42-usfmt2-4.conf"
fi
if get_ip_down "fe80::1817:15" "dn42-de2-4"; then
    update_wg_peer dn42-de2-4 "2JYyWk0jF4PA6c77t6BZRgGP9qqw8Df5ixTiFPQX8yY=" "$ip_de2_4:13485" "igp_tunnels/dn42-de2-4.conf"
fi
if get_ip_down "fe80::1817:15" "dn42-de2-6"; then
    update_wg_peer dn42-de2-6 "2JYyWk0jF4PA6c77t6BZRgGP9qqw8Df5ixTiFPQX8yY=" "$ip_de2_6:13486" "igp_tunnels/dn42-de2-6.conf"
fi


wg set dn42-cnzj-4 peer "e/lg8d/pOJA3sEBqrdTNZ6dMd5ZRCXR0oNfXQW5KIjw=" endpoint "$ip_cnzj_4:14873"
wg set dn42-cnzj-6 peer "e/lg8d/pOJA3sEBqrdTNZ6dMd5ZRCXR0oNfXQW5KIjw=" endpoint "$ip_cnzj_6:14874"
